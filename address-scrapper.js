...
program
  ...
  .option('-d, --databaseUrl <string>', 'The url to connect with the MongoDB database (default: "loki.db")')
  .option('-d, --databaseName <string>', 'The name of the MongoDB database (default: "mongodb://localhost:27017/")')
